...
// initial begin
//     wd_cnt = 0;
//     // 等复位结束后再开始计时（你现在 rstn 低了 10 个周期）
//     wait(rstn === 1'b1);
//     repeat (2) @(posedge clk);

//     // 这里给一个足够大的周期数（按你 bulk 长度调大/调小）
//     // 比如 5,000,000 个 clk：100MHz 下约 50ms 仿真时间
//     while (wd_cnt < 500) begin
//         @(posedge clk);
//         wd_cnt = wd_cnt + 1;
//     end

//     $display("\n[FATAL] TB watchdog timeout! simulation stuck.");
//     $display("time=%0t, wd_cnt=%0d", $time, wd_cnt);
//     $finish;
// end
