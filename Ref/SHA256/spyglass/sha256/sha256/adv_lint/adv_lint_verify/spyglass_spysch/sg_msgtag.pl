...
spyParseTextMessageTagFile("./sha256/sha256/adv_lint/adv_lint_verify/spyglass_spysch/sg_msgtag.txt");
...
spyMessageTagTestBenchmark(62,"./sha256/sha256/adv_lint/adv_lint_verify/spyglass.vdb");
